...
GITHUB_REPOSITORY=${GITHUB_REPOSITORY:-gaojulong/blueos-self}
REMOTE="${REMOTE:-https://raw.githubusercontent.com/${GITHUB_REPOSITORY}}"
ROOT="$REMOTE/$VERSION"

DOCKER_VERSION="${DOCKER_VERSION:-1.1.0-alpha.3}"
BLUEOS_BOOTSTRAP="gaojulong/blueos-bootstrap:$DOCKER_VERSION" # Use current version
BLUEOS_CORE="gaojulong/blueos-core:$DOCKER_VERSION" # We don't have a stable tag yet
BLUEOS_FACTORY="gaojulong/blueos-core:factory" # used for "factory reset"
...
RUNNING_IN_CI=1 # default to not running CI mode/docker-in-docker
